pro  SARscape_script_import_Sentinel_1_master

  compile_opt idl2

  infoRoutine = ROUTINE_INFO('SARscape_script_import_Sentinel_1_master', /SOURCE)
  ...
  inOrbits = paths[params['pathorbitmaster']] + PATH_SEP()+ paths[params['fileorbitmaster']]
