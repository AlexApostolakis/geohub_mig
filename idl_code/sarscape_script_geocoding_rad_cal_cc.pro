pro  sarscape_script_geocoding_rad_cal_cc

  compile_opt idl2

  infoRoutine = ROUTINE_INFO('sarscape_script_geocoding_rad_cal_cc', /SOURCE)
  ...
  inRasterName_data = FILE_SEARCH(output, '*'+params['filtering_out']+'_cc') 
  outRasterName = output+PATH_SEP() + params['filtering_out']+'_cc_ql'+params['geocoding_out']
