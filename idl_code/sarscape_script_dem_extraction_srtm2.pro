pro  SARscape_script_dem_extraction_srtm2

  compile_opt idl2

  infoRoutine = ROUTINE_INFO('SARscape_script_dem_extraction_srtm2', /SOURCE)
...
; 3) Create the TOOLSDEMEXTRACTIONSRTM4 object
  OB = obj_new('SARscapeBatch',Module='TOOLSDEMEXTRACTIONSRTM2')
  ...
  obj_params=params['dem_srtm2_xml_params']
